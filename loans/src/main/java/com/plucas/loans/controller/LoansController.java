package com.plucas.loans.controller;
...
@Tag(
        ...
        description = "CRUD REST APIs in plucas to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside plucas"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
